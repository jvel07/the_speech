...
def get_xvecs(list_sets, dest_task):
    for i in list_sets:
        ...
        np.savetxt('../data/{0}/{1}/xvecs/xvecs-20mfcc-0del-{2}dim-BEA16kNoAugSpecial-{3}.xvecs'.format(dest_task, dest_task, x.shape[1], dest_task), x)
        print(x.shape)

get_xvecs(['s'], 'demencia94ABC')
