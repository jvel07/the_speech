...
def do_fishers():
    ...
    for deltas in [0, 1, 2]:
        ...
        list_files_ubm = [
            '../../data/CovidCough/train/flevel/mfcc_CovidCough_23_train_{}del.mfcc'.format(deltas),
            '../../data/CovidCough/dev/flevel/mfcc_CovidCough_23_dev_{}del.mfcc'.format(deltas)
                          ]
        for folder_name in list_sets:
            list_mfcc_files = util.traverse_dir_2(feature_dir + folder_name, '*{}_{}_{}del.{}'.format(feats_info[0],
                                                                                                    folder_name,
