...
for name in list_sets:
    ...
    for g in num_clusters:
        means, covs, priors, LL, posteriors = vlf.gmm.gmm(array_mfccs_1, g)
        # fisher encoding
        list_fisher = []
        ...
        obs = '2del'
        # Output file (fishers)
        file_fishers = 'C:/Users/Win10/PycharmProjects/the_speech/data/fisher/fisher-{}-{}-{}-{}'.format(num_feats, obs, g, name)
