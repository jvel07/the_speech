...
def mfccs_bkaldi(signal, num_feats, num_deltas, cepstral_type="mfcc", raw_energy=True, num_mel_bins=23, low_freq=20,
                              high_freq=0):
...
def compute_mfccs(list_wavs, out_dir, obs, num_feats, num_deltas, recipe, folder_name,cepstral_type="mfcc",
    ...
    # Output details
    observation = '{}del_{}'.format(num_deltas, obs)
    ...
    for wav in list_wavs:
        mfcc = mfccs_bkaldi(wav, num_feats, num_deltas, cepstral_type=cepstral_type,
