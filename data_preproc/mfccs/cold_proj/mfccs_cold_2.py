...
if __name__ == '__main__':
    ...
    # Output files
    observation = 'train_2del'
    num_mfccs = 13
    file_mfccs_cold = work_dir + '/data/mfccs/cold/mfccs_cold_{}_{}'.format(num_mfccs, observation)
    ...
    for name in list_sets:
        ...
        audio_list = util.read_files_from_dir(dir_wavs)  # Reading augmented dementia files
